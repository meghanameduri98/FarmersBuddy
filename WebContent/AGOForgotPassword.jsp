...
<center>
	<form action="AGOForgotServlet" method="post" name="form" onsubmit="return validate()">
	<br><h1 ><i><u><b>NOTE:- Enter your Login Name to Give your Password</b></u></i></h1>
	<table>
	...
	<br>
	<p align="center"><a href="AGOLogin.jsp">Go Back</a>
</center>
<div class="footer">
