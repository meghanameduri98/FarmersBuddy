...
@media screen and (max-width: 800px) {
  .leftcolumn, .rightcolumn {   
	...
	<br><br><br><br><br><br><br><br><br>
		<p align="center" style="font-size:20px"> Your password changed successfully</p>
		<p align="center" style="font-size:20px"><a href="AGOLogin.jsp">Go Back to AGOLogin Page</a></p>
	</center>
	<div class="footer">
