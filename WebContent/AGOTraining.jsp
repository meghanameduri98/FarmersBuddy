...
<center>
<h1 align="center"><u><i><b>Training Requests Solutions</b></i></u></h1>
<%
	try {
		Class.forName("oracle.jdbc.driver.OracleDriver");
		Connection conn=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","root");
		Statement stmt=conn.createStatement();
		ResultSet rs=stmt.executeQuery("select * from mytrainingans2");
...
%>
<br>
<p><a href="Traintable.jsp">Go Back</a></p>
	</center>
	<div class="footer">
