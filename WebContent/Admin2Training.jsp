...
<center>
<br>
<h1 align="center"><i><u><b>Training Requested Solutions</b></u></i></h1>
<%
	try {
		Class.forName("oracle.jdbc.driver.OracleDriver");
		Connection conn=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","root");
		Statement stmt=conn.createStatement();
		ResultSet rs=stmt.executeQuery("select * from mytrainingans");
...
%><br>
<p><a href="AdminTraining.jsp">Go Back</a></p>
	</center>
	<div class="footer">
