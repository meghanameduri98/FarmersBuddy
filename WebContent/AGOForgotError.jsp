  ...
  .leftcolumn, .rightcolumn {   
	...
	<div class="navbar">
		...
		<br><br><br><br><br><br><br><br><br>
			<p align="center" style="font-size:20px">your Login doesn't match, Please try again!!....</p>
			<br>
			<p align="center" style="font-size:20px"><a href="AGOForgotPassword.jsp">Go Back</a></p>
		</center>
		<div class="footer">
