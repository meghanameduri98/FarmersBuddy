  ...
  .leftcolumn, .rightcolumn {   
	...
	<a href="WebHome.jsp" class="right"> LogOut </a>
			  <a href="About.jsp" class="right"> About us </a>
			   <a href="AGOSoil.jsp" class="right"> Soil </a>
	...
	<br><br><br><br><br><br>
		<p align="center" style="font-size:40px;font-family:Arial"> AGO Login Successful </p>
		<p align="center" style="font-size:40px">"Happy Learning"</p>
		<div class="footer">
