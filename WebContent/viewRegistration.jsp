...
<div class="navbar">
			  ...
			  <a href="AdminSoil.jsp" class="right">Soil</a>
		...
		<br>
		<h1 align="center"><i><u><b>Registered Users</b></u></i></h1>
<%
	try {
		Class.forName("oracle.jdbc.driver.OracleDriver");
		Connection conn=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","system","root");
		Statement stmt=conn.createStatement();
		ResultSet rs=stmt.executeQuery("select * from myuserregistration");
...
<th width="25">Desigation</th>
<th width="25">LoginName</th>
...
<center>
<br>
	<p><a href="Security.jsp">Go Back</a></p>
</center>
<div class="footer">
